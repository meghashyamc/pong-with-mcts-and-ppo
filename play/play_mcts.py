...
class MCTSPlayer:
    ...
    def __init__(
        ...
        self.mcts_agent = MCTS(iteration_limit=self.num_of_iterations)
        self.reward_frequency = reward_frequency
        self._setup_result_paths()

    def _setup_result_paths(self):
        self.csv_folder = f"results/{self.env_name}/mcts/{self.num_of_iterations}"
